...
```javascript
FLOAT32_EXPONENT_MASK = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-exponent-mask@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-exponent-mask@v0.1.0-umd/browser.js"></script>
```
